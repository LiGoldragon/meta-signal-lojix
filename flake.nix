{
  description = "meta-signal-lojix — generated meta Lojix Signal contract";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        checks = {
          ...
          no-free-functions = pkgs.runCommand "meta-signal-lojix-no-free-functions" { inherit src; } ''
            ${builtins.readFile ./checks/no-free-functions.sh}
          '';
          no-inherent-methods = pkgs.runCommand "meta-signal-lojix-no-inherent-methods" { inherit src; } ''
