...
/// The allocated privileged Lojix wire contract: stable seat 6, structural revision 3.
...
impl signal_frame::WireContract for MetaLojixWire {
    const BINDING: signal_frame::ContractBinding = signal_frame::ContractBinding::new(
        signal_frame::ContractId::new(core::num::NonZeroU32::new(6).expect("meta Lojix seat is nonzero")),
